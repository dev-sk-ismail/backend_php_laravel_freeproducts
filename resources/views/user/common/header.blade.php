...
<head>
    ...
    <link rel='icon' type='image/png' href='images/fvicon_icon.png'>
    <title> {{ trans('user/site.title')}} - {{ trans('user/site.sub-title')}} </title>
    <!-- Fonts -->
    <link rel="dns-prefetch" href="//fonts.gstatic.com">
    <link href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet">
    <!--<link media="all" type="text/css" rel="stylesheet" href="{{asset('assets/user/css/animate.min.css')}}">-->
    <!-- Styles -->
    <link media="all" type="text/css" rel="stylesheet" href="{{asset('assets/user/css/frontend.css') }}">
    ...
    <link media="all" type="text/css" rel="stylesheet" href="{{asset('assets/user/css/lander.css')}}">
    <link media="all" type="text/css" rel="stylesheet" href="{{asset('assets/user/css/font-awesome.min.css')}}">
    <style type="text/css">
        .klaviyo_messages {
            text-align: left;
